...
const WDCalendarStyleWrapper = styled('div')`
  ...
  button[disabled].rbc-button-link {
    cursor: not-allowed;
  }
  ...
  .rbc-button-link-group > button:first-child:not(:last-child) {
    border-top-right-radius: 0;
    border-bottom-right-radius: 0;
  }
  .rbc-button-link-group > button:last-child:not(:first-child) {
    border-top-left-radius: 0;
    border-bottom-left-radius: 0;
  }
  .rbc-rtl .rbc-button-link-group > button:first-child:not(:last-child) {
    border-radius: 0;
    border-top-left-radius: 0;
    border-bottom-left-radius: 0;
  }
  .rbc-rtl .rbc-button-link-group > button:last-child:not(:first-child) {
    border-radius: 0;
    border-top-right-radius: 0;
    border-bottom-right-radius: 0;
  }
  .rbc-button-link-group > button:not(:first-child):not(:last-child) {
    border-radius: 0;
  }
  .rbc-button-link-group button + button {
    margin: ${(props) =>
      props['data-rtl'] === 'rtl' ? '0 -1px 0 0' : '0 0 0 -1px'};
  }
  .rbc-rtl .rbc-button-link-group button + button {
    margin-left: 0;
    margin-right: -1px;
  }
  .rbc-button-link-group + .rbc-button-link-group,
  .rbc-button-link-group + button {
    margin-left: 10px;
  }
  .rbc-event {
    border: none;
