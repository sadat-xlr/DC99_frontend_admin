...
const BoardLayout = ({
  ...
  const projectDropdownItems = [
    {
      key: 'projects-header',
      label: <DropdownHeader>Projects</DropdownHeader>,
    },
    {
  ...
  Object.values(boards).forEach((board, index) =>
    projectDropdownItems.splice(index + 1, 0, {
      key: board.id,
      label: (
  ...
  return (
    ...
    >
      <Header>
        <Dropdown
          overlay={<Menu items={projectDropdownItems} />}
          overlayClassName="project-menu"
        >
          <div>
            <ProjectInfoCard>
              <Avatar src={AvatarIcon} />
        ...
        <AssigneeWrapper>
          ...
          <Tooltip
            title="Please Implements Your Own Assign Methods"
