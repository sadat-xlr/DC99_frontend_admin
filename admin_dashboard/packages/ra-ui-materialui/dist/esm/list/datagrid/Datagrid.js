...
export var Datagrid = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(DatagridContextProvider, { value: contextValue },
        React.createElement(DatagridRoot, { sx: sx, className: DatagridClasses.root },
