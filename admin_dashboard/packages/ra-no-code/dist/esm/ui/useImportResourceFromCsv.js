...
import { getValuesFromRecords, useDataProvider } from 'react-admin';
import set from 'lodash/set';
import { useResourcesConfiguration, getFieldDefinitionsFromRecords, } from '../ResourceConfiguration';
/**
 ...
 */
export var useImportResourceFromCsv = function () {
    var _a = useState(false), parsing = _a[0], setParsing = _a[1];
    var dataProvider = useDataProvider();
    var _b = useResourcesConfiguration(), resources = _b[0], addResource = _b[1].addResource;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.sent();
                    setParsing(false);
                    fields = getFieldDefinitionsFromRecords(records);
...
var sanitizeRecord = function (records, values, field) {
    ...
    if (fieldValues.some(function (value) {
        ...
        return records.map(function (record) {
            return set(record, field, Boolean(record[field]));
        });
    }
    return records;
};
//# sourceMappingURL=useImportResourceFromCsv.js.map