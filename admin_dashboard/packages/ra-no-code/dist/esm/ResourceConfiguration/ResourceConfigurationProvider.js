...
export var ResourceConfigurationProvider = function (_a) {
    var children = _a.children, dataProvider = _a.dataProvider, _b = _a.storageKey, storageKey = _b === void 0 ? STORAGE_KEY : _b;
    var _c = useState(function () { return loadConfigurationsFromLocalStorage(storageKey); }), resources = _c[0], setInternalResources = _c[1];
    var setResources = useCallback(function (value) {
    ...
    var addResource = useCallback(function (resource) {
    ...
    var updateResource = useCallback(function (name, newResource) {
        setResources(function (current) {
            var _a;
            var allResources = current || {};
    ...
    var removeResource = useCallback(function (name) {
        setResources(function (current) {
            var allResources = current || {};
    ...
    return (React.createElement(ResourceConfigurationContext.Provider, { value: context }, children));
};
export var STORAGE_KEY = '@@ra-no-code';
...
//# sourceMappingURL=ResourceConfigurationProvider.js.map